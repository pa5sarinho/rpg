...
document.addEventListener("click", function(event)
{
    ...
    {
        let btn_observar = document.getElementById('btn-observar');
        let btn_viraqui = document.getElementById('btn-viraqui');
        let btn_acampar = document.getElementById('btn-acampar');
